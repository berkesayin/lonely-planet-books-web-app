...
if(@$_POST["submit"]){
    ...
    if($ekle->execute()) {
        ...
        header("Location: hakkimizda.php?i=ekle");  //i ile bir değişken yollayalım.
    }
    else {
        //print_r($ekle->errorInfo());  //hata varsa bize bilgi verir
        header("Location: hakkimizda.php?i=hata"); // eğer hata varsa blog.php sayfasında bar kısmında i=hata yazar
    }
